...
namespace KaraokeNeeNee
{
    public partial class QL_Đặt_Phòng : Form
    {
       ...
       // private Label ma;
        ...
        {
            cn = new SqlConnection(@"Data Source=CHINHCHINT\MSSQLSERVER01;Initial Catalog=KARAOKE_NEENEE;Integrated Security=True");
        ...
        private void GetData()
        {
            ...
            {
                /*ma = new Label();
                ma.Text = dr["maP"].ToString();
                ma.Width = 50;
                ma.BackColor = Color.Yellow;
                ma.TextAlign = ContentAlignment.MiddleCenter;
                ma.Click += new System.EventHandler(ma_Click);*/
        ...
        private void btTim_Click(object sender, EventArgs e)
        {
            ...
            dr.Close();
            cn.Close();
            if (cbSN.Text == "5" && cbLP.Text == "Phòng VIP")
            {
                MessageBox.Show("Không có phòng VIP dành cho 5 người", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        }
        ...
        {
            using (SqlConnection cnn = new SqlConnection(@"Data Source=CHINHCHINT\MSSQLSERVER01;Initial Catalog=KARAOKE_NEENEE;Integrated Security=True"))
            {
